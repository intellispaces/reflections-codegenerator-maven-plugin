package tech.intellispaces.reflectionsj.generator.maven.plugin;
...
import tech.intellispaces.reflectionsj.generator.maven.plugin.configuration.ConfigurationLoaderFunctions;
import tech.intellispaces.reflectionsj.generator.maven.plugin.configuration.Settings;
import tech.intellispaces.reflectionsj.generator.maven.plugin.configuration.SettingsProvider;
import tech.intellispaces.reflectionsj.generator.maven.plugin.generation.GenerationFunctions;
import tech.intellispaces.reflectionsj.generator.maven.plugin.specification.SpecificationReadFunctions;
...
@Mojo(
    name = "reflectionsj-generator",
    defaultPhase = LifecyclePhase.GENERATE_SOURCES
)
public class ReflectionsJGeneratorMojo extends AbstractMojo {
  ...
  @Parameter(
      ...
      defaultValue = "${project.build.directory}/generated-sources/reflectionsj",
      required = true)
